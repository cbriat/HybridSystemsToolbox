...
[Kc,Kd,R,P,info] = MaxDT_Impulsive_Stabilization(A,Bc,J,Bd,T,d);
...
x0 = [-1 1];
options = [];
[t,x,hf,hl] = SimImpSyst(A+Bc*Kc,J+Bd*Kd,x0,seqT,options);
[t,td,x,yc,yd,hf,hl] = SimImpSystOut(A+Bc*Kc,J+Bd*Kd,Kc,Kd,x0,seqT,options);